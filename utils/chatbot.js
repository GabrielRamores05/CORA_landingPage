...
function getResponse(intent, userInput) {
  const defaultMenu = `Or you can simply type a number from 1-15 to ask your question! 😊
...
15. Paano ko i-install ang CORA?`;
  ...
  switch (intent) {
    ...
    case 'pricing':
      return "Ang CORA po starts at ₱36,000 annually 😊\n\nThis helps automate cooperative operations, accounting, records, and reporting para mas mabilis at organized ang workflow.\n\nWe can also guide you po based sa size and needs ng cooperative ninyo 😊\n\nWould you like po ba makita ang actual demo or mas malaman ang package options?";
    case 'trusted':
